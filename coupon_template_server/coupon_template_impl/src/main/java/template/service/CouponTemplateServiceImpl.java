...
import beans.CouponTemplateInfo;
import beans.PageCouponTemplateInfo;
import beans.TemplateSearchParams;
import template.CouponTemplateDao;
import template.converter.CouponTemplateConverter;
import template.service.intf.CouponTemplateService;
import template.entity.CouponTemplate;
   ...
   // @Autowired
    ...
    public PageCouponTemplateInfo search(TemplateSearchParams request) {
        ...
        PageCouponTemplateInfo response = PageCouponTemplateInfo.builder()
                .templateInfos(couponTemplateInfos)
